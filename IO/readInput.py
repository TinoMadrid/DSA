...
def readFile(table):
    ...
    distanceTable[25].extend((
                             4.4, 2.8, 10.1, 5.4, 3.5, 5.1, 6.2, 2.8, 3.2, 11.0, 3.7, 2.8, 6.4, 6.5, 5.7, 6.2, 5.1, 4.3,
...
def address_lookup(fromLocation, toLocation, addressTable, distanceTable):
    for begin in addressTable:
        if begin[0] == fromLocation:                        # if the first index element is the origin
            ...
            distance = distanceTable[matchingCoordinates[0].index(0)][matchingCoordinates[0].index(1)]
            print(distance)